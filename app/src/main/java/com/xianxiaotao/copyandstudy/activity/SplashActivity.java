...
import com.xianxiaotao.copyandstudy.xcopy.xiaoma.TransitionPlayer;
...
public class SplashActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPathBtn = (Button) findViewById(R.id.through);
        ...
        ((ImageView) view1.findViewById(R.id.description)).setImageResource(R.drawable.xiaoma_intro_bottom_text1);
        viewArray.add(view1);
        ...
        ((ImageView) view2.findViewById(R.id.description)).setImageResource(R.drawable.xiaoma_intro_bottom_text2);
        viewArray.add(view2);
        ...
        ((ImageView) view3.findViewById(R.id.description)).setImageResource(R.drawable.xiaoma_intro_bottom_text3);
        viewArray.add(view3);
        ...
        ((ImageView) view4.findViewById(R.id.description)).setImageResource(R.drawable.xiaoma_intro_bottom_text4);
        viewArray.add(view4);
    ...
    private void enter() {
        if (SaveUtil.isLogged(getApplicationContext())) {
