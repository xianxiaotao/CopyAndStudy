...
public class XClipProgress extends FrameLayout {
    ...
    public XClipProgress(Context context) {
        this(context, null, 0);
    }

    public XClipProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XClipProgress(Context context, AttributeSet attrs, int defStyle) {
